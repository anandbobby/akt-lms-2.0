...
trait timespentonsite {
    ...
    public function get_timespentonsite_data(
        ...
        $timespentonsite = $this->get_users_timespent_on_site($startdate, $enddate, $userid);
        $oldtimespentonsite = $this->get_users_timespent_on_site($oldstartdate, $oldenddate, $userid);
