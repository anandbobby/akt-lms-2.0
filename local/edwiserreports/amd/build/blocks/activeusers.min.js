...
define('local_edwiserreports/blocks/activeusers', [
    ...
    function getActiveUsersBlockData() {
        ...
        PROMISE.GET_DATA().done(function(response) {
            ...
            $(SELECTOR.PANEL).find('.download-links input[name="filter"]').val(filter.daterange);
    ...
    function download(format, filename, response) {
        ...
        switch (format) {
            case 'pdfimage':
                ...
                common.exportGraphPDF(activeUsersGraph, filter.daterange, graphElement.width(), graphElement.height(), filename);
                break;
            case 'jpeg':
                common.exportGraphJPEG(activeUsersGraph, filter.daterange, filename);
                break;
            case 'png':
                common.exportGraphPNG(activeUsersGraph, filter.daterange, filename);
                break;
            case 'svg':
                common.exportGraphSVG(activeUsersGraph, filter.daterange, filename);
                break;
        }
    }
